...
\setcounter{docType}{1} % лучше не редактировать 

%%%% Настройки автора / Author settings
%% 
\input{my_folder/my_settings} % добавляем свои команды / update your 
...
%\input{my_folder/title_for_practice} 	% Титульный лист для
										%преддипломной практики	



\input{my_folder/task_}				 % Задание 
										 % После подписания задания изменение его содержания и оформления запрещено

%\input{my_folder/task_for_practice}		% Задание на преддипломную 
										% практику
							

\input{my_folder/plan}	
